        ...
        <div className="space-y-6">
            ...
            <div className="relative max-w-md">
                ...
                <input
                    ...
                    className="w-full bg-[#f8f9fa]/60 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-800 placeholder:text-slate-600 focus:outline-none focus:border-blue-500 transition-colors"
                />
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                    {filtered.map((inst, idx) => (
                        <a
                            ...
                            className="group flex items-start gap-3 bg-[#f8f9fa]/60 border border-slate-200/60 hover:border-blue-500/40 rounded-xl p-4 transition-all duration-200 hover:bg-white"
                        >
                            <div className="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-400 group-hover:bg-blue-500 group-hover:text-[#8422dc] transition-all shrink-0 mt-0.5">
