...
export function CityCensusStats({ data, cityName, zipCodes = [], areaCodes = [], timezone }: CityCensusStatsProps) {
    if (!data) {
        return (
            <div className="p-6 border border-dashed border-zinc-800 rounded-3xl bg-zinc-900/50 text-center">
    ...
    return (
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-[10px] font-black uppercase text-zinc-500">Population Reach</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-[10px] font-black uppercase text-zinc-500">Median Income</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-black text-white italic tracking-tighter">
                            {data.medianIncome > 0 ? `$${data.medianIncome.toLocaleString()}` : "N/A"}
                        </div>
                        <p className="text-[10px] font-bold text-zinc-500 uppercase mt-1">Per Year / Household</p>
                    </CardContent>
                </Card>

                <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-[10px] font-black uppercase text-zinc-500">Median Age</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="bg-zinc-900 border-zinc-800 rounded-2xl border-emerald-500/20">
                    <CardHeader className="pb-2">
                    ...
                    <CardContent>
                        ...
                        <p className="text-[10px] font-bold text-zinc-500 uppercase mt-1">Optimal Strategy</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <Tabs defaultValue="audience" className="w-full">
                ...
                <TabsContent value="audience" className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between p-2 bg-zinc-800 rounded-xl border border-zinc-700">
                                        <span className="text-[9px] font-black text-zinc-500 uppercase">ZIP Codes</span>
                                        <div className="flex flex-wrap gap-1 justify-end max-w-[120px]">
                                            {zipCodes.length > 0 ? zipCodes.slice(0, 3).map(zip => (
                                                <Badge key={zip} variant="outline" className="text-[9px] h-4 bg-zinc-700 border-zinc-600 text-zinc-300">{zip}</Badge>
                                            )) : <span className="text-[9px] font-bold text-zinc-600 italic">No data</span>}
                                            {zipCodes.length > 3 && <span className="text-[8px] text-zinc-600 font-black">+{zipCodes.length - 3}</span>}
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between p-2 bg-zinc-800 rounded-xl border border-zinc-700">
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <Progress value={data.audience.maritalStatus.divorcedPct} className="h-1 bg-zinc-800" indicatorClassName="bg-zinc-500" />
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 gap-4 pt-2">
                                    <div className="p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                                        ...
                                        <p className="text-[8px] font-black text-zinc-500 uppercase tracking-widest">Kids 0-18</p>
                                    </div>
                                    <div className="p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                             ...
                             <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                                        ...
                                        <p className="text-[8px] font-black text-zinc-500 uppercase tracking-widest">Under 18</p>
                                    </div>
                                    <div className="p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                                        <div className="text-xl font-black text-white italic">{data.audience.over65Pct}%</div>
                                        <p className="text-[8px] font-black text-zinc-500 uppercase tracking-widest">65+ Senior</p>
                                    </div>
                                </div>
                        ...
                        <Card className="bg-zinc-900 border-zinc-800 rounded-2xl lg:col-span-1 md:col-span-2">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-xs font-black uppercase flex items-center gap-2 text-white">
                            ...
                            <CardContent>
                                <div className="p-4 bg-emerald-500/5 border border-emerald-500/20 rounded-xl">
                                    <h4 className="text-sm font-black text-emerald-500 uppercase italic">Recommended Persona</h4>
                                ...
                                <div className="space-y-4 pt-2">
                                    {[
                                        ...
                                        <div key={b.label} className="space-y-1">
                                            ...
                                            <Progress value={b.val} className={`h-1.5 bg-zinc-800`} indicatorClassName={b.color} />
                                        </div>
                                    ))}
                                </div>
                            </CardContent>
                                ...
                                <CardContent className="space-y-3">
                                    ...
                                    <div className="pt-2">
                                        <div className="flex justify-between text-[10px] font-bold uppercase text-zinc-400 mb-1">
                                            ...
                                            <span className={data.affordability.costBurdenedPct > 35 ? "text-red-400" : "text-emerald-500"}>{data.affordability.costBurdenedPct}%</span>
                                        </div>
                                        <Progress value={data.affordability.costBurdenedPct} className="h-1 bg-zinc-800" />
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <CardContent className="space-y-3">
                                {[
                                    ...
                                    <div key={e.label} className="space-y-1">
                                        ...
                                        <Progress value={(e.val / totalPop) * 100} className="h-1 bg-zinc-800" indicatorClassName={e.color} />
                                    </div>
                                ))}
                            </CardContent>
                        </Card>
                         ...
                         <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
                            ...
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Progress value={data.digital.broadbandPct} className="h-1 bg-zinc-800" indicatorClassName="bg-cyan-500" />
                                </div>
                                <div className="flex items-center justify-between p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                                    <div className="flex items-center gap-2">
                                        <Smartphone className="h-3 w-3 text-zinc-500" />
                                        <span className="text-[10px] font-black text-zinc-500 uppercase">Smartphone Only</span>
                                    </div>
                                    <span className="text-sm font-black text-white">{data.digital.smartphoneOnlyPct}%</span>
                                </div>
                                <p className="text-[9px] font-bold text-zinc-400 uppercase italic mt-4">
                        ...
                        <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-[8px] font-black text-zinc-500 uppercase">Drive Alone</span>
                                        </div>
                                    ...
                                    <div className="p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-[8px] font-black text-zinc-500 uppercase">Transit</span>
                                        </div>
                                ...
                                <div className="pt-2 border-t border-zinc-800">
                                    ...
                                    <p className="text-[10px] font-bold text-zinc-500 uppercase">Avg Commute Time</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={lang.label} className="flex items-center justify-between p-2 bg-zinc-950 rounded-xl border border-zinc-800">
                                            <div className="flex items-center gap-2">
                                                <Globe className="h-3 w-3 text-cyan-500" />
                                                <span className="text-[9px] font-black text-zinc-500 uppercase">{lang.label}</span>
                                            </div>
                                ...
                                <div className="p-3 bg-cyan-500/5 border border-cyan-500/20 rounded-xl">
                                    ...
                                    <p className="text-[8px] font-black text-zinc-500 uppercase tracking-widest mt-1">Bachelor's Degree or Higher</p>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
                            ...
                            <CardContent className="space-y-4">
                                {data.economy.topIndustries.map((ind) => {
                                    const colors: Record<string, string> = {
                                        ...
                                        "Agri/Mining": "bg-brown-500",
                                    };
                                    const colorClass = colors[ind.name] || "bg-zinc-600";
                                    return (
                        ...
                        <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
                            ...
                            <CardContent className="space-y-4">
                                {data.economy.topOccupations.map((occ) => {
                                    ...
                                    const colorClass = colors[occ.name] || "bg-zinc-600";
                                    return (
                        ...
                        <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-1 gap-2 pt-2">
                                    <div className="flex items-center justify-between p-2 bg-zinc-950 rounded-xl border border-zinc-800 border-l-4 border-l-cyan-500">
                                        <span className="text-[9px] font-black text-zinc-500 uppercase">Private</span>
                                        <span className="text-sm font-black text-white italic">{data.economy.employmentType.private}%</span>
                                    </div>
                                    <div className="flex items-center justify-between p-2 bg-zinc-950 rounded-xl border border-zinc-800 border-l-4 border-l-blue-500">
                                        <span className="text-[9px] font-black text-zinc-500 uppercase">Public</span>
                                        <span className="text-sm font-black text-white italic">{data.economy.employmentType.public}%</span>
                                    </div>
                                    <div className="flex items-center justify-between p-2 bg-zinc-950 rounded-xl border border-zinc-800 border-l-4 border-l-emerald-500">
                                        <span className="text-[9px] font-black text-zinc-500 uppercase">SMB/Self</span>
                                        <span className="text-sm font-black text-white italic">{data.economy.employmentType.selfEmployed}%</span>
                                    </div>
                                </div>
                                <p className="text-[8px] font-bold text-zinc-500 uppercase italic leading-tight">
                        ...
                        {data.nicheInsights.candidates.map((niche) => (
                            <Card key={niche.id} className="bg-zinc-900 border-zinc-800 rounded-2xl overflow-hidden hover:border-purple-500/30 transition-all border-b-2 border-b-purple-500/20 flex flex-col">
                                ...
                                <CardContent className="p-4 flex-1 flex flex-col">
                                    ...
                                    <p className="text-[10px] font-bold text-zinc-400 leading-relaxed uppercase mb-4">{niche.description}</p>
                                    
                                    <div className="mt-auto space-y-3">
                                        <div className="p-3 bg-zinc-950 rounded-xl border border-zinc-800">
                                            <p className="text-[8px] font-black text-zinc-500 uppercase tracking-widest mb-2">Data Signals</p>
                                        ...
                                        <Progress value={niche.score * 10} className="h-1 bg-zinc-800" indicatorClassName={niche.score >= 8 ? "bg-emerald-500" : niche.score >= 5 ? "bg-blue-500" : "bg-amber-500"} />
                                    </div>
                                </CardContent>
                            </Card>
                        ))}
            ...
            <div className="pt-12 border-t border-zinc-800 flex flex-col md:flex-row justify-between gap-6 opacity-60 transition-opacity hover:opacity-100">
                ...
                <Badge variant="outline" className="h-fit bg-zinc-900 border-zinc-800 text-zinc-400 text-[8px] font-black uppercase py-0.5">
