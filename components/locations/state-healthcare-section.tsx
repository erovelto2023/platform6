...
import { Activity, Search, Building2, Bed, TrendingUp, DollarSign, ExternalLink, MapPin, Phone, Shield, Stethoscope } from "lucide-react";
...
export function StateHealthcareSection({ hospitals = [], stats, stateName }: StateHealthcareSectionProps) {
    ...
    return (
        <div className="space-y-10">
            ...
            <div className="flex items-center justify-between border-l-4 border-cyan-500 pl-6 mb-6">
                <div>
                    ...
                    <p className="text-slate-400 text-xs font-mono font-bold uppercase tracking-wider mt-1">
                        Registered Hospitals, Specialty Centers & Medical Facilities ({hospitals.length})
                    </p>
                </div>
            </div>
                        ...
                        {filtered.map((hosp, idx) => (
                            ...
                            >
                                ...
                                <div className="mt-5 pt-3 border-t border-slate-800 flex items-center justify-between text-xs text-slate-400 font-mono">
                                    <span className="truncate max-w-[120px]">{hosp.type || 'General Acute Care'}</span>
                                    <div className="flex items-center gap-2">
                                        ...
                                        {hosp.website && (
                                            <a 
                                                ...
                                                title="Visit medical facility website"
                                            >
