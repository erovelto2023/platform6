        ...
        <div className="space-y-12 mt-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-3 space-y-8">
                    <Card className="bg-zinc-900 border-zinc-800 rounded-2xl overflow-hidden border-t-4 border-t-blue-500">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4 text-white">
                                {searchIntent.length > 0 ? (
                                    searchIntent.slice(0, 8).map((intent, i) => (
                                        <div key={i} className="flex items-center gap-3 p-3 bg-zinc-950 border border-zinc-800 rounded-xl group hover:border-blue-500/30 transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Card className="bg-zinc-900 border-zinc-800 rounded-2xl border-l-4 border-l-blue-500">
                            <CardHeader className="pb-2">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            const satColor = saturation === "Untapped" ? "text-emerald-500" : saturation === "Low" ? "text-blue-400" : "text-amber-400";
