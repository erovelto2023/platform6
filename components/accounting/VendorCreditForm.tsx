...
import { createVendorCredit } from "@/lib/actions/vendor-credit.actions";
...
export default function VendorCreditForm({ vendors }: VendorCreditFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        startTransition(async () => {
            ...
            if (res.error) {
                ...
                showToast("Vendor Credit recorded successfully!", "success");
                setTimeout(() => router.push("/accounting/vendor-credits"), 1500);
            }
        });
    };
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-[#0d1117] border border-slate-800/80 rounded-2xl p-6">
                <h2 className="text-sm font-black text-white mb-4 uppercase tracking-wider">Credit Information</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input value={refNo} onChange={e => setRefNo(e.target.value)} placeholder="e.g. CR-9932" className={inputCls} />
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-[#0d1117] border border-slate-800/80 rounded-2xl p-5 space-y-3 h-fit">
                        <div className="border-b border-slate-800 pb-3 flex justify-between items-end">
                            <span className="text-sm font-bold text-slate-400">Total Credit</span>
                        ...
                        <div className="pt-3 space-y-2">
                            <button
                                type="submit"
                                disabled={isPending}
                                className="w-full py-2.5 bg-[#059669] hover:bg-[#047857] disabled:opacity-40 text-white font-bold text-sm rounded-xl transition-all shadow-lg shadow-emerald-500/20"
                            >
                                {isPending ? "Recording..." : "Record Credit"}
                            </button>
                            <button
                                type="button"
                                onClick={() => router.back()}
