...
import {
    Wrench, FileCode, CheckSquare, ArrowRight,
    Facebook, Youtube, Download
} from "lucide-react";
    ...
    const heroSlides = [
        {
            ...
            subtitle: 'A curated collection of tools, templates, and guides to help you scale your business.',
            ...
            <main className="flex-1">
                ...
                <section className="w-full py-20 bg-slate-900 relative overflow-hidden">
                    ...
                    <div className="container px-4 md:px-6 mx-auto relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            >
                                Stop reinventing the wheel. Use our battle-tested templates, tools, and systems to grow faster.
                            </motion.p>
                            ...
                            >
                                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-orange-500/50 transition-all">
                                    <Wrench className="h-10 w-10 text-orange-400 mb-4" />
                                    <h3 className="text-xl font-bold text-white mb-2">Essential Tools</h3>
                                    <p className="text-slate-400 text-sm">Software and utilities to automate and streamline your operations.</p>
                                </div>
                                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-indigo-500/50 transition-all">
                                    <FileCode className="h-10 w-10 text-indigo-400 mb-4" />
                                    <h3 className="text-xl font-bold text-white mb-2">Plug-and-Play Templates</h3>
                                    <p className="text-slate-400 text-sm">Copy-paste solutions for emails, landing pages, and marketing content.</p>
                                </div>
                                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-red-500/50 transition-all">
                                    <CheckSquare className="h-10 w-10 text-red-400 mb-4" />
                                    <h3 className="text-xl font-bold text-white mb-2">SOPs & Checklists</h3>
                                    <p className="text-slate-400 text-sm">Standard Operating Procedures to delegate and manage effectively.</p>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                ...
                <section className="w-full py-24 bg-slate-950 border-t border-slate-800">
                    <div className="container px-4 md:px-6 mx-auto text-center">
                        <h2 className="text-3xl font-bold text-white mb-8">Upgrade Your Toolkit</h2>
                        <Link href="/sign-up">
                            <Button size="lg" className="bg-white text-slate-900 hover:bg-slate-100 rounded-full px-8 text-lg font-semibold">
                                Get All Resources <ArrowRight className="ml-2 h-5 w-5" />
                            </Button>
                        </Link>
                    </div>
                </section>
