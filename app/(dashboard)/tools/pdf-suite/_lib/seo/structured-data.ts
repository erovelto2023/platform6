...
import type { Tool, ToolContent, FAQ, HowToStep } from '@/app/(dashboard)/tools/pdf-suite/_types/tool';
import type { Locale } from '@/app/(dashboard)/tools/pdf-suite/_lib/i18n/config';
