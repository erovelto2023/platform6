...
import { siteConfig } from '@/app/(dashboard)/tools/pdf-suite/_config/site';
import { type Locale, localeConfig, locales } from '@/app/(dashboard)/tools/pdf-suite/_lib/i18n/config';
import type { Tool, ToolContent } from '@/app/(dashboard)/tools/pdf-suite/_types/tool';
