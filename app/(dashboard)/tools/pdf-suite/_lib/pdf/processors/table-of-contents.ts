...
import type { ProcessInput, ProcessOutput, ProgressCallback } from '@/app/(dashboard)/tools/pdf-suite/_types/pdf';
import { PDFErrorCode } from '@/app/(dashboard)/tools/pdf-suite/_types/pdf';
