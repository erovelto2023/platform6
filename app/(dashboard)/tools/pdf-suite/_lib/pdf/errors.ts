...
import type { PDFError } from '@/app/(dashboard)/tools/pdf-suite/_types/pdf';
import { PDFErrorCode, ErrorCategory, ERROR_CODE_CATEGORY } from '@/app/(dashboard)/tools/pdf-suite/_types/pdf';
import type { Locale } from '@/app/(dashboard)/tools/pdf-suite/_types/i18n';
