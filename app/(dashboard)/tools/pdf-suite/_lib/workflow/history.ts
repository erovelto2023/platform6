...
import type { WorkflowExecutionRecord, WorkflowHistoryStorage } from '@/app/(dashboard)/tools/pdf-suite/_types/workflow-history';
import type { WorkflowNode, WorkflowEdge } from '@/app/(dashboard)/tools/pdf-suite/_types/workflow';
