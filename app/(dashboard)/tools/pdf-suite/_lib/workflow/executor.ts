...
import { WorkflowNode, WorkflowEdge, WorkflowOutputFile } from '@/app/(dashboard)/tools/pdf-suite/_types/workflow';
import type { ProcessOutput, ProgressCallback, ProcessInput } from '@/app/(dashboard)/tools/pdf-suite/_types/pdf';
import { PDFErrorCode, ErrorCategory } from '@/app/(dashboard)/tools/pdf-suite/_types/pdf';
import { logger } from '@/app/(dashboard)/tools/pdf-suite/_lib/utils/logger';

// Import Processor classes
import { MergePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/merge';
import { SplitPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/split';
import { RotatePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/rotate';
import { CompressPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/compress';
import { FlattenPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/flatten';
import { ExtractPagesPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/extract';
import { DeletePagesPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/delete';
import { AlternateMergePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/alternate-merge';
import { DividePagesPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/divide';
import { AddBlankPagePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/add-blank-page';
import { ReversePagesPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/reverse';
import { NUpPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/n-up';
import { CombineSinglePagePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/combine-single-page';
import { PosterizePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/posterize';
import { EditMetadataPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/edit-metadata';
import { TableOfContentsProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/table-of-contents';
import { PageNumbersProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/page-numbers';
import { WatermarkProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/watermark';
import { HeaderFooterProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/header-footer';
import { InvertColorsProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/invert-colors';
import { BackgroundColorProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/background-color';
import { TextColorProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/text-color';
import { RemoveAnnotationsProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/remove-annotations';
import { RemoveBlankPagesProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/remove-blank-pages';
import { ImageToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/image-to-pdf';
import { TextToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/text-to-pdf';
import { JSONToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/json-to-pdf';
import { PDFToImageProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-image';
import { PDFToSVGProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-svg';
import { PDFToGreyscaleProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-greyscale';
import { PDFToJSONProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-json';
import { OCRProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/ocr';
import { FixPageSizeProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/fix-page-size';
import { LinearizePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/linearize';
import { RemoveRestrictionsProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/remove-restrictions';
import { RepairPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/repair';
import { EncryptPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/encrypt';
import { DecryptPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/decrypt';
import { SanitizePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/sanitize';
import { RemoveMetadataProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/remove-metadata';
import { ChangePermissionsProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/change-permissions';
import { WordToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/word-to-pdf';
import { ExcelToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/excel-to-pdf';
import { PPTXToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pptx-to-pdf';
import { EPUBToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/epub-to-pdf';
import { FB2ToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/fb2-to-pdf';
import { MOBIToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/mobi-to-pdf';
import { RTFToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/rtf-to-pdf';
import { XPSToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/xps-to-pdf';
import { GridCombineProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/grid-combine';
import { ExtractImagesPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/extract-images';
import { PDFToZipProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-zip';
import { OrganizePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/organize';
import { DeskewPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/deskew';
import { EmailToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/email-to-pdf';
import { FontToOutlineProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/font-to-outline';
import { StampsProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/stamps';
import { DJVUToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/djvu-to-pdf';
import { CbzToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/cbz-to-pdf';
import { BookletPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/booklet';
import { MarkdownToPDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/markdown-to-pdf';
import { ExtractTablesProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/extract-tables';
import { RasterizePDFProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/rasterize';
import { PdfToPdfAProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-pdfa';
import { PDFToDocxProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-docx';
import { PDFToPptxProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-pptx';
import { PDFToExcelProcessor } from '@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/pdf-to-excel';
        ...
        switch (toolId) {
            ...
            case 'split-pdf': {
                ...
                if (mode === 'every') {
                    ...
                    const { parsePageRanges } = await import('@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/split');
            ...
            case 'digital-sign-pdf': {
                ...
                const { parsePfxFile, parseCombinedPem, signPdf } = await import('@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/digital-sign');
            ...
            case 'extract-attachments': {
                if (files.length === 0) throw new Error('No input file');
                const { ExtractAttachmentsPDFProcessor } = await import('@/app/(dashboard)/tools/pdf-suite/_lib/pdf/processors/attachments');
