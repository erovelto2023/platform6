import type { ProcessOutput } from '@/app/(dashboard)/tools/pdf-suite/_types/pdf';
import type { WorkflowOutputFile } from '@/app/(dashboard)/tools/pdf-suite/_types/workflow';
